...
export class DatabaseService implements OnModuleInit, OnModuleDestroy {
  ...
  // ============================================
  async signUp(emailOrData: any, password?: string, name?: string, arg4?: any, arg5?: any): Promise<any> {
    if (typeof emailOrData === 'object') {
      return registerUser(this.pool, this.authConfig, emailOrData);
    }
    // arg4 and arg5 can be (metadata, role) OR (role, metadata) — detect by type:
    // - if arg4 is a string and arg5 is an object → (role, metadata)
    // - otherwise treat arg4 as metadata, arg5 as role
    let metadata: any = {};
    let role: string | undefined;
    if (typeof arg4 === 'string' && (arg5 === undefined || typeof arg5 === 'object')) {
      role = arg4;
      metadata = arg5 || {};
    } else {
      metadata = arg4 || {};
      role = typeof arg5 === 'string' ? arg5 : undefined;
    }
    return registerUser(this.pool, this.authConfig, {
      email: emailOrData,
      password: password!,
      name,
